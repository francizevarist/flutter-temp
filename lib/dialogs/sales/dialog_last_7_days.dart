...
class SalesLast7DaysDialog extends StatefulWidget {
  @override
  _SalesLast7DaysDialogState createState() => _SalesLast7DaysDialogState();
}

class _SalesLast7DaysDialogState extends State<SalesLast7DaysDialog> {
  List<SalesItemLast7Days> salesItems = [];
  bool isLoading = true;
                ...
                return Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return SalesLast7DaysCard(
                        transactionSale:
                        "\$${salesItem.transactionSale.toString()}",
                        transactionCount:
                        salesItem.transactionCount.toString(),
